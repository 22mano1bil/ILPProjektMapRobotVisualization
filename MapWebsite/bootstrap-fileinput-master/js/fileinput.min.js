 ...
 */!function(e) {
    ...
    var i = function(e) {
        ...
        return t.innerHTML = "<!--[if IE " + e + "]><i></i><![endif]-->", i = 1 === t.getElementsByTagName("i").length, document.body.appendChild(t), t.parentNode.removeChild(t), i
            ...
            i.length > 0 && !M(i) && (i = i.split(e.initialPreviewDelimiter)), t.data[a] = {content: i, config: e.initialPreviewConfig, tags: e.initialPreviewThumbTags, delimiter: e.initialPreviewDelimiter, template: e.previewGenericTemplate, msg: function(i) {
                    return e.getMsgSelected(i)
                }, initId: e.previewInitId, footer: e.getLayoutTemplate("footer"), isDelete: e.initialPreviewShowDelete, caption: e.initialCaption, actions: function(i, t, a, n, r, l) {
                    return e.renderFileActions(i, t, a, n, r, l)
                }}
        }, fetch: function(e) {
            ...
            return a = void 0 === a ? !0 : a, null === l.content[i] ? "" : (n = l.template.repl("{previewId}", o).repl("{frameClass}", " file-preview-initial").repl("{fileindex}", r).repl("{content}", l.content[i]).repl("{footer}", t.footer(e, i, a)), l.tags.length && l.tags[i] && (n = q(n, l.tags[i])), n)
        }, add: function(i, a, n, r, l) {
            var o, s = e.extend(!0, {}, t.data[i]);
            return M(a) || (a = a.split(s.delimiter)), l ? (o = s.content.push(a) - 1, s.config[o] = n, s.tags[o] = r) : (o = a.length, s.content = a, s.config = n, s.tags = r), t.data[i] = s, o
            ...
            var n = t.data[e];
            if (a = void 0 === a ? !0 : a, 0 === n.config.length || z(n.config[i]))
                return"";
            var r = n.config[i], l = B("caption", r) ? r.caption : "", o = B("width", r) ? r.width : "auto", s = B("url", r) ? r.url : !1, d = B("key", r) ? r.key : null, c = s === !1 && a, p = n.isDelete ? n.actions(!1, !0, c, s, d, i) : "", f = n.footer.repl("{actions}", p);
            return f.repl("{caption}", l).repl("{width}", o).repl("{indicator}", "").repl("{indicatorTitle}", "")
        }}, a = ".file-preview-frame:not(.file-preview-initial)", n = function(e, i) {
    ...
    V.prototype = {constructor: V, init: function(a) {
            ...
            var i = this, t = B(e, i.layoutTemplates) ? i.layoutTemplates[e] : j[e];
            return z(i.customLayoutTags) ? t : q(t, i.customLayoutTags)
        }, getPreviewTemplate: function(e) {
            var i = this, t = B(e, i.previewTemplates) ? i.previewTemplates[e] : A[e];
            ...
            i.$preview.find(a).each(function() {
                var a = e(this), r = a.attr("data-fileindex"), l = i.filestack[r];
                -1 !== r && (void 0 !== l ? (n[t] = l, a.attr({id: i.previewInitId + "-" + t, "data-fileindex": t}), t += 1) : a.attr({id: "uploaded-" + Z(), "data-fileindex": "-1"}))
            }), i.filestack = n
        }, refresh: function(i) {
            ...
            return n.isUploadable ? (t = l.repl("{actions}", n.renderFileActions(!0, !0, !1, !1, !1, !1)), a = t.repl("{caption}", e).repl("{width}", i).repl("{indicator}", r.indicatorNew).repl("{indicatorTitle}", r.indicatorNewTitle)) : a = l.repl("{actions}", "").repl("{caption}", e).repl("{width}", i).repl("{indicator}", "").repl("{indicatorTitle}", ""), a = q(a, n.previewThumbTags)
        }, renderFileActions: function(e, i, t, a, n, r) {
            if (!e && !i)
                return"";
            var l = this, o = a === !1 ? "" : ' data-url="' + a + '"', s = n === !1 ? "" : ' data-key="' + n + '"', d = l.getLayoutTemplate("actionDelete"), c = "", p = l.getLayoutTemplate("actions"), f = l.otherActionButtons.repl("{dataKey}", s), u = l.fileActionSettings, v = t ? u.removeClass + " disabled" : u.removeClass;
            return d = d.repl("{removeClass}", v).repl("{removeIcon}", u.removeIcon).repl("{removeTitle}", u.removeTitle).repl("{dataUrl}", o).repl("{dataKey}", s), e && (c = l.getLayoutTemplate("actionUpload").repl("{uploadClass}", u.uploadClass).repl("{uploadIcon}", u.uploadIcon).repl("{uploadTitle}", u.uploadTitle)), p.repl("{delete}", d).repl("{upload}", c).repl("{other}", f)
        }, initPreview: function(e) {
            var i, a = this, n = a.initialCaption || "";
            return t.count(a.id) ? (i = t.out(a.id), n = e && a.initialCaption ? a.initialCaption : i.caption, a.$preview.html(i.content), a.setCaption(n), void(z(i.content) || a.$container.removeClass("file-input-new"))) : (a.$preview.html(""), void(e ? a.setCaption(n) : a.initCaption()))
        }, initPreviewDeletes: function() {
            var i = this, a = i.deleteExtraData || {}, n = function() {
                0 === i.$preview.find(".kv-file-remove").length && (i.reset(), i.initialCaption = "")
            };
            i.$preview.find(".kv-file-remove").each(function() {
                var r = e(this), l = r.data("url") || i.deleteUrl, o = r.data("key");
                if (!z(l) && void 0 !== o) {
                    var d, c, p, f, u = r.closest(".file-preview-frame"), v = t.data[i.id], h = u.data("fileindex");
                    h = parseInt(h.replace("init_", "")), p = z(v.config) && z(v.config[h]) ? null : v.config[h], f = z(p) || z(p.extra) ? a : p.extra, "function" == typeof f && (f = f()), c = {id: r.attr("id"), key: o, extra: f}, d = e.extend({url: l, type: "DELETE", dataType: "json", data: e.extend({key: o}, f), beforeSend: function(e) {
                            i.ajaxAborted = !1, i.raise("filepredelete", [o, e, f]), i.ajaxAborted ? e.abort() : (s(u, "file-uploading"), s(r, "disabled"))
                            ...
                            return void 0 !== e && void 0 !== e.error ? (c.jqXHR = l, c.response = e, i.showError(e.error, c, "filedeleteerror"), u.removeClass("file-uploading"), r.removeClass("disabled"), void n()) : (t.unset(i.id, h), s = t.count(i.id), d = s > 0 ? i.getMsgSelected(s) : "", i.raise("filedeleted", [o, l, f]), i.setCaption(d), u.removeClass("file-uploading").addClass("file-deleted"), void u.fadeOut("slow", function() {
                                i.clearObjects(u), u.remove(), n(), s || 0 !== i.getFileStack().length || (i.setCaption(""), i.reset())
                            }))
                        }, error: function(e, t, a) {
                            var r = i.parseError(e, a);
                            c.jqXHR = e, c.response = {}, i.showError(r, c, "filedeleteerror"), u.removeClass("file-uploading"), n()
            ...
            var e = this;
            e.uploadCache = {content: [], config: [], tags: [], append: !0}, e.uploadCount = 0, e.uploadPercent = 0, e.$btnUpload.removeAttr("disabled"), e.setProgress(0), s(e.$progress, "hide"), e.resetErrors(!1), e.ajaxAborted = !1, e.ajaxRequests = []
        }, cancel: function() {
            var i, t = this, n = t.ajaxRequests, r = n.length;
            if (r > 0)
                for (i = 0; r > i; i += 1)
                    n[i].abort();
            ...
            var i, n = this;
            n.$btnUpload.removeAttr("disabled"), n.resetUpload(), n.filestack = [], n.clearFileInput(), n.resetErrors(!0), n.raise("fileclear"), !n.overwriteInitial && t.count(n.id) ? (n.showFileIcon(), n.resetPreview(), n.setEllipsis(), n.initPreviewDeletes(), n.$container.removeClass("file-input-new")) : (n.$preview.find(a).each(function() {
                n.clearObjects(e(this))
            }), n.$preview.html(""), i = !n.overwriteInitial && n.initialCaption.length > 0 ? n.initialCaption : "", n.setCaption(i), n.setEllipsis(), n.$caption.attr("title", ""), s(n.$container, "file-input-new")), 0 === n.$container.find(".file-preview-frame").length && (n.initCaption() || n.$captionContainer.find(".kv-caption-icon").hide(), n.setEllipsis()), n.hideFileIcon(), n.raise("filecleared"), n.$captionContainer.focus(), n.setFileDropZoneTitle()
            ...
            l.uploadExtra(), r = e.extend({xhr: function() {
                ...
                }, url: l.uploadUrl, type: "POST", dataType: "json", data: l.formdata, cache: !1, processData: !1, contentType: !1, beforeSend: i, success: t, complete: a, error: n}, l.ajaxSettings), l.ajaxRequests.push(e.ajax(r))
        }, initUploadSuccess: function(i, a, n) {
            var r, l, o, s, d, c, p, f = this;
            "object" != typeof i || e.isEmptyObject(i) || void 0 !== i.initialPreview && i.initialPreview.length > 0 && (f.hasInitData = !0, d = i.initialPreview || [], c = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], r = void 0 === i.append || i.append ? !0 : !1, f.overwriteInitial = !1, void 0 === a || n ? n ? (f.uploadCache.content.push(d[0]), f.uploadCache.config.push(c[0]), f.uploadCache.tags.push(p[0]), f.uploadCache.append = r) : (t.set(f.id, d, c, p, r), f.initPreview(), f.initPreviewDeletes()) : (o = t.add(f.id, d, c[0], p[0], r), l = t.get(f.id, o, !1), s = e(l).hide(), a.after(s).fadeOut("slow", function() {
                s.fadeIn("slow").css("display:inline-block"), f.initPreviewDeletes(), f.clearFileInput()
            })))
        }, uploadSingle: function(i, n, r) {
            var l, o, d, c, p, f, u, v, h, m, g = this, w = g.getFileStack().length, b = new FormData, x = g.previewInitId + "-" + i, C = e("#" + x + ":not(.file-preview-initial)"), y = C.find(".kv-file-upload"), E = C.find(".kv-file-remove"), $ = C.find(".file-upload-indicator"), T = g.fileActionSettings, F = g.filestack.length > 0 || !e.isEmptyObject(g.uploadExtraData), k = {id: x, index: i};
            g.formdata = b, 0 === w || !F || y.hasClass("disabled") || g.abort(k) || (d = function() {
                ...
                e.length > 0 || g.fileBatchCompleted || (g.fileBatchCompleted = !0, setTimeout(function() {
                    t.set(g.id, g.uploadCache.content, g.uploadCache.config, g.uploadCache.tags, g.uploadCache.append), g.hasInitData && (g.initPreview(), g.initPreviewDeletes()), g.setProgress(100), g.unlock(), g.clearFileInput(), g.raise("filebatchuploadcomplete", [g.filestack, g.getExtraData()])
                }, 100))
            }, c = function(e, i) {
                $.html(T[e]), $.attr("title", T[i])
            }, p = function() {
                !r || 0 === w || g.uploadPercent >= 100 || (g.uploadCount += 1, o = 80 + Math.ceil(20 * g.uploadCount / w), g.uploadPercent = Math.max(o, g.uploadPercent), g.setProgress(g.uploadPercent), g.initPreviewDeletes())
            }, f = function() {
                y.removeAttr("disabled"), E.removeAttr("disabled"), C.removeClass("file-uploading")
            }, u = function(t) {
                l = g.getOutData(t), c("indicatorLoading", "indicatorLoadingTitle"), s(C, "file-uploading"), y.attr("disabled", !0), E.attr("disabled", !0), r || g.lock(), g.raise("filepreupload", [l, x, i]), k = e.extend(k, l), g.abort(k) && (t.abort(), g.setProgress(100))
            }, v = function(t, a, n) {
                l = g.getOutData(n, t), k = e.extend(k, l), setTimeout(function() {
                    void 0 === t.error ? (c("indicatorSuccess", "indicatorSuccessTitle"), y.hide(), E.hide(), g.filestack[i] = void 0, g.raise("fileuploaded", [l, x, i]), g.initUploadSuccess(t, C, r), r || g.resetFileStack()) : (c("indicatorError", "indicatorErrorTitle"), g.showUploadError(t.error, k))
                }, 100)
            }, h = function() {
                setTimeout(function() {
                    p(), f(), r ? d() : g.unlock(!1)
                ...
                var o = g.parseError(t, l, r ? n[i].name : null);
                c("indicatorError", "indicatorErrorTitle"), k = e.extend(k, g.getOutData(t)), g.showUploadError(o, k)
            }, b.append(g.uploadFileAttr, n[i]), b.append("file_id", i), g.ajaxSubmit(u, v, h, m))
        }, uploadBatch: function() {
            var i, t, n, r, l, o, d, c, p = this, f = p.filestack, u = f.length, v = p.filestack.length > 0 || !e.isEmptyObject(p.uploadExtraData), h = {};
            p.formdata = new FormData, 0 !== u && v && !p.abort(h) && (i = p.fileActionSettings, t = function(t, a, n) {
                var r = e("#" + p.previewInitId + "-" + t).find(".file-upload-indicator");
                r.html(i[a]), r.attr("title", i[n])
            }, r = function(i) {
                var t = e("#" + p.previewInitId + "-" + i + ":not(.file-preview-initial)"), a = t.find(".kv-file-upload"), n = t.find(".kv-file-delete");
                ...
                p.showPreview && p.$preview.find(a).each(function() {
                    var i = e(this), t = i.find(".kv-file-upload"), a = i.find(".kv-file-remove");
                    s(i, "file-uploading"), t.attr("disabled", !0), a.attr("disabled", !0)
                }), p.raise("filebatchpreupload", [t]), p.abort(t) && i.abort()
            }, o = function(i, l, o) {
                var s = p.getOutData(o, i), d = z(i.errorkeys) ? [] : i.errorkeys;
                void 0 === i.error || z(i.error) ? (p.raise("filebatchuploadsuccess", [s]), n(), p.showPreview ? (p.$preview.find(".kv-file-upload").hide(), p.$preview.find(".kv-file-remove").hide(), p.$preview.find(a).each(function() {
                    var i = e(this), a = i.attr("data-fileindex");
                    t(a, "indicatorSuccess", "indicatorSuccessTitle"), r(a)
                }), p.initUploadSuccess(i)) : p.reset()) : (p.showPreview && (p.$preview.find(a).each(function() {
                    var i = e(this), a = parseInt(i.attr("data-fileindex"), 10);
                    return r(a), 0 === d.length ? void t(a, "indicatorError", "indicatorErrorTitle") : void(-1 !== e.inArray(a, d) ? t(a, "indicatorError", "indicatorErrorTitle") : (i.find(".kv-file-upload").hide(), i.find(".kv-file-remove").hide(), t(a, "indicatorSuccess", "indicatorSuccessTitle"), p.filestack[a] = void 0))
                }), p.initUploadSuccess(i)), p.showUploadError(i.error, s, "filebatchuploaderror"))
            }, d = function() {
                p.setProgress(100), p.unlock(), p.raise("filebatchuploadcomplete", [p.filestack, p.getExtraData()]), p.clearFileInput()
            }, c = function(i, n, r) {
                var l = p.getOutData(i), o = p.parseError(i, r);
                p.showUploadError(o, l, "filebatchuploaderror"), p.uploadFileCount = u - 1, p.showPreview && (p.$preview.find(a).each(function() {
                    var i = e(this), a = i.attr("data-fileindex");
                    i.removeClass("file-uploading"), void 0 !== p.filestack[a] && t(a, "indicatorError", "indicatorErrorTitle")
                }), p.$preview.find(a).removeClass("file-uploading"), p.$preview.find(a + " .kv-file-upload").removeAttr("disabled"), p.$preview.find(a + " .kv-file-delete").removeAttr("disabled"))
            }, e.each(f, function(e, i) {
                z(f[e]) || p.formdata.append(p.uploadFileAttr, i)
            }), p.ajaxSubmit(l, o, d, c))
            ...
            n.formdata = new FormData, n.abort(r) || (e = function(e) {
                ...
                void 0 === e.error || z(e.error) ? (n.raise("filebatchuploadsuccess", [a]), n.clearFileInput(), n.initUploadSuccess(e)) : n.showUploadError(e.error, a, "filebatchuploaderror")
            }, t = function() {
            ...
            return i = i || {}, i.reader = a.reader, n.html(e), n.fadeIn(800), a.raise(r, [i]), a.isUploadable || a.clearFileInput(), s(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
            ...
            for (n = 0; n < L.length; n += 1)
                if (a = L[n], i = B(a, r.fileTypeSettings) ? r.fileTypeSettings[a] : R[a], t = i(e.type, e.name) ? a : "", !z(t))
                    return t;
            return"other"
        }, previewDefault: function(i, t, a) {
            if (this.showPreview) {
                var n = this, r = H.createObjectURL(i), l = e("#" + t), o = n.previewSettings.other, s = n.renderFileFooter(i.name, o.width), d = n.getPreviewTemplate("other"), c = t.slice(t.lastIndexOf("-") + 1), p = "";
            ...
            function t(e) {
                ...
                var m, g, w, b, x, C, y = v + e, E = p + "-" + y, $ = i[e], T = a.slug($.name), F = ($.size || 0) / 1e3, k = "", I = H.createObjectURL($), D = 0, P = a.allowedFileTypes, S = z(P) ? "" : P.join(", "), U = a.allowedFileExtensions, j = z(U) ? "" : U.join(", ");
                if (z(U) || (k = new RegExp("\\.(" + U.join("|") + ")$", "i")), F = F.toFixed(2), a.maxFileSize > 0 && F > a.maxFileSize)
                    return b = a.msgSizeTooLarge.repl("{name}", T).repl("{size}", F).repl("{maxSize}", a.maxFileSize), void(a.isError = h(b, $, E, e));
                if (!z(P) && M(P)) {
                    for (w = 0; w < P.length; w += 1)
                        x = P[w], g = u[x], C = void 0 !== g && g($.type, T), D += z(C) ? 0 : C.length;
                    if (0 === D)
                        return b = a.msgInvalidFileType.repl("{name}", T).repl("{types}", S), void(a.isError = h(b, $, E, e))
                }
                return 0 !== D || z(U) || !M(U) || z(k) || (C = T.match(k), D += z(C) ? 0 : C.length, 0 !== D) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.repl("{index}", e + 1).repl("{files}", f)), o.addClass("loading"), l.onerror = function(e) {
                    a.errorHandler(e, T)
                }, l.onload = function(e) {
                    a.previewFile($, e, E, I), a.initFileActions()
                }, l.onloadend = function() {
                    b = c.repl("{index}", e + 1).repl("{files}", f).repl("{percent}", 50).repl("{name}", T), setTimeout(function() {
                        s.html(b), H.revokeObjectURL(I)
                    ...
                    if (i.lengthComputable) {
                        ...
                        b = c.repl("{index}", e + 1).repl("{files}", f).repl("{percent}", a).repl("{name}", T), setTimeout(function() {
                            s.html(b)
                        }, 100)
                    }
                }, m = B("text", u) ? u.text : R.text, m($.type, T) ? l.readAsText($, a.textEncoding) : l.readAsArrayBuffer($)) : (a.previewDefault($, E), setTimeout(function() {
                    t(e + 1), a.updateFileDetails(f)
            ...
            var a = this, n = a.$element, r = a.$preview, l = a.reader, o = a.$previewContainer, s = a.$previewStatus, d = a.msgLoading, c = a.msgProgress, p = a.previewInitId, f = i.length, u = a.fileTypeSettings, v = a.filestack.length, h = function(t, n, r, l) {
            ...
            if (!a.isUploadable && z(n.val()) && a.fileInputCleared)
                return void(a.fileInputCleared = !1);
            a.fileInputCleared = !1;
            var r, l, o, s, d = a.$preview, c = arguments.length > 1, p = c ? i.originalEvent.dataTransfer.files : n.get(0).files, f = z(n.attr("multiple")), u = 0, v = 0, h = a.filestack.length, m = a.isUploadable, g = function(i, t, n, r) {
            ...
            if (a.reader = null, a.resetUpload(), a.hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c)
                for (r = []; p[u]; )
                    s = p[u], s.type || s.size % 4096 !== 0 ? r.push(s) : v++, u++;
            else
        ...
        if (r() || i(9)) {
            ...
            return a.shift(), this.each(function() {
                ...
                n || (n = new V(this, e.extend({}, e.fn.fileinput.defaults, r, e(this).data())), i.data("fileinput", n)), "string" == typeof t && n[t].apply(n, a)
            })
        }
